                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-g-6">
                                        ...
                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="identity_number" name="identity_number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Identity Number" value="{{ $patientDetail[0]->identity_number }}">
                                            <!--end::Input-->
