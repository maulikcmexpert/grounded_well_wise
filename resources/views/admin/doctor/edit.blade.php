                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" id="formattedNumber" name="identity_number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Indentification Number" value="{{ substr($doctorDetail[0]->identity_number, 0, 6) . ' ' . substr($doctorDetail[0]->identity_number, 6, 4) . ' ' . substr($doctorDetail[0]->identity_number, 10, 3)}}">
                                        <!--end::Input-->
